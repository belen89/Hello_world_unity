...
struct  List_1_t673  : public Object_t
{
	// T[] System.Collections.Generic.List`1<Vuforia.ISmartTerrainEventHandler>::_items
	ISmartTerrainEventHandlerU5BU5D_t3286* ____items_1;
...
struct List_1_t673_StaticFields{
	// T[] System.Collections.Generic.List`1<Vuforia.ISmartTerrainEventHandler>::EmptyArray
	ISmartTerrainEventHandlerU5BU5D_t3286* ___EmptyArray_4;
};
