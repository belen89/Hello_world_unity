...
struct  ThreadSafeDictionary_2_t1180  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1179 * ____valueFactory_1;
	...
	Dictionary_2_t3581 * ____dictionary_2;
};
