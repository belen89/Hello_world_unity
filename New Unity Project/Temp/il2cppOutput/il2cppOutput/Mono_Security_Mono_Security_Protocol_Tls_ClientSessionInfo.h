...
struct  ClientSessionInfo_t1732  : public Object_t
{
	...
	ByteU5BU5D_t583* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t583* ___masterSecret_5;
};
struct ClientSessionInfo_t1732_StaticFields{
