...
struct  List_1_t724  : public Object_t
{
	// T[] System.Collections.Generic.List`1<Vuforia.IVirtualButtonEventHandler>::_items
	IVirtualButtonEventHandlerU5BU5D_t3430* ____items_1;
...
struct List_1_t724_StaticFields{
	// T[] System.Collections.Generic.List`1<Vuforia.IVirtualButtonEventHandler>::EmptyArray
	IVirtualButtonEventHandlerU5BU5D_t3430* ___EmptyArray_4;
};
