...
struct  X509Store_t1498  : public Object_t
{
	...
	X509Certificate2Collection_t1489 * ___list_2;
	...
	X509Store_t1511 * ___store_4;
};
struct X509Store_t1498_StaticFields{
	...
	Dictionary_2_t950 * ___U3CU3Ef__switchU24mapF_5;
};
