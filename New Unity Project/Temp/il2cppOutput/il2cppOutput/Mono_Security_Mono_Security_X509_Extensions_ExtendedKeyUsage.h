...
struct  ExtendedKeyUsageExtension_t1709  : public X509Extension_t1602
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1436 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1709_StaticFields{
	...
	Dictionary_2_t950 * ___U3CU3Ef__switchU24map14_4;
};
